...
const Icons: FC<iconPropType> = ({ iconType, className = 'fill-secondary' }) => {
  switch (iconType) {
    case 'check':
      return (
        <svg width="10" height="8" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    case 'addTaskMobile':
      return (
        <svg width="12" height="12" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    case 'arrowUp':
      return (
        <svg width="10" height="7" xmlns="http://www.w3.org/2000/svg">
          <path stroke="#635FC7" strokeWidth="2" fill="none" d="m1 1 4 4 4-4" className={className} />
        </svg>
      );
    case 'darkTheme':
      return (
    ...
    case 'hideSidebar':
      return (
        <svg width="18" height="16" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    case 'lightTheme':
      return (
        <svg width="19" height="19" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    case 'showSidebar':
      return (
        <svg className={className} width="16" height="11" xmlns="http://www.w3.org/2000/svg">
    ...
    case 'menu':
      return (
        <svg className={className} width="5" height="20" xmlns="http://www.w3.org/2000/svg">
          <g fillRule="evenodd">
    ...
    case 'logoDark':
      return (
        <svg className={className} width="153" height="26" xmlns="http://www.w3.org/2000/svg">
    ...
    case 'logoMobile':
      return (
        <svg className={className} width="24" height="25" xmlns="http://www.w3.org/2000/svg">
    ...
    case 'cross':
      return (
        <svg width="15" height="15" xmlns="http://www.w3.org/2000/svg" className={className}>
